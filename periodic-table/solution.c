...
int main()
{
    ...
    else if (n == 2)
    {
        ...
        if (Exit == 6)
        {
            ...
            {
                printf("Periodic table has not closed and you can continue to learn more about more elements\n\n");
        ...
        {
            printf("Periodic table has not closed and you can control to learn more elements\n\n");
